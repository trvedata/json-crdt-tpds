...
\begin{definition}[document state]
...
In this appendix we provide a proof of the theorem stated in Section~\ref{sec:convergence}. We begin with some lemmas about ordered lists, and then work our way towards more complex composite JSON documents.
