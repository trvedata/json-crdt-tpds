...
\draw [thick,->] (left1)  -- (left2)
    node [left,text width=4cm,text centered,midway]  {doc.get(``grocery'').idx(0) .insert(``eggs'');};
\draw [thick,->] (right1) -- (right2)
    node [right,text width=4cm,text centered,midway] {doc.get(``grocery'').idx(0) .insert(``milk'');};
\draw [thick,->] (left2)  -- (left3)
    node [left,text width=4cm,text centered,midway]  {doc.get(``grocery'').idx(1) .insert(``ham'');};
\draw [thick,->] (right2) -- (right3)
    node [right,text width=4cm,text centered,midway] {doc.get(``grocery'').idx(1) .insert(``flour'');};
...
\draw [thick,->] (left2)  to node [left]  {doc.idx(1).insert(``x'');} (left3);
\draw [thick,->] (right1) to node [right] {doc.idx(0).insert(``y'');} (right2);
\draw [thick,->] (right2) to node [right] {doc.idx(2).insert(``z'');} (right3);
\draw [thick,->] (left3)  to (left4);
\draw [thick,->] (right3) to (right4);
\draw [thick,dashed,blue,->] (left3.south)  to [out=270,in=135] (right4.north west);
\draw [thick,dashed,blue,->] (right3.south) to [out=270,in=45]  (left4.north east);
...
\draw [thick,->] (right2) to node [right] {doc.get(``a'').idx(0).insert(``z'');} (right3);
\draw [thick,->] (left3)  to (left4);
\draw [thick,->] (right3) to (right4);
\draw [thick,dashed,blue,->] (left3.south)  to [out=270,in=135] (right4.north west);
\draw [thick,dashed,blue,->] (right3.south) to [out=270,in=45]  (left4.north east);
...
head.insert("eggs");
let tail = doc.get("shopping").idx(1);
head.insert("cheese");
tail.insert("milk");
