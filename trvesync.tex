...
\draw [thick,->] (start) to node [left,inner sep=12pt] {\footnotesize doc[``colors''][``red''] := ``\#ff0000'';} (left1);
\draw [thick,->] (start) to node [right,inner sep=18pt] {\footnotesize doc[``colors''] = \{\};} (right1);
